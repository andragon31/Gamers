...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2018 a las 10:01:39
...
CREATE TABLE `sala` (
  ...
  `FondoSala` varchar(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sala` (`IDSala`, `NombreSala`, `FondoSala`) VALUES
(1, 'FIFA 18', 'img/fifa18n.jpg'),
(2, 'Call of Duty', 'img/cod.jpg'),
(3, 'Smash Bros', 'img/smash.png'),
(4, 'Fortnite', 'img/fortnite.jpg'),
(5, 'League of Legends', 'img/mordekaiser.jpg'),
(6, 'Clash of Clans', 'img/clash.png');
...
(7, 'guts', 'horda10', 'berserk@hotmail.com'),
(8, 'mincho', '$2y$10$sOs5NLKG1GPe3fuEHt58uuMuyWijv5qnOSY2X.aB2ejxJ6Xoq5v6u', 'mincho@hotmail.com');
...
--
ALTER TABLE `usuariosxsala`
  MODIFY `IDUsuariosxSala` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
